...
<body>
    ...
    <?php
        ...
        $reponseNbHeuresParMedecin = $bdd->query("SELECT SUM(duree)/60, medecin.nom FROM consultation, medecin WHERE medecin.id_medecin = rdv.id_medecin GROUP BY medecin.id_medecin");

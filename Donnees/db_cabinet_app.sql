...
INSERT INTO usager (civilite, nom, prenom, sexe, adresse, code_postal, ville, date_nais, lieu_nais, num_secu, id_medecin) VALUES ('M.', 'Itadori', 'Yuji', 'H', '123 Fantasy Street', '75001', 'Magic City', '1996-03-20', 'Fairyland', '123456789012345', 1);
...
INSERT INTO usager (civilite, nom, prenom, sexe, adresse, code_postal, ville, date_nais, lieu_nais, num_secu, id_medecin) VALUES ('M.', 'Fushiguro', 'Megumi', 'H', '789 Fantasy Street', '75003', 'Magic City', '1998-12-22', 'Fairyland', '345678901234567', 3);
INSERT INTO usager (civilite, nom, prenom, sexe, adresse, code_postal, ville, date_nais, lieu_nais, num_secu, id_medecin) VALUES ('M.', 'Satoru', 'Gojo', 'H', '88 Tokyo Street', '75003', 'Tokyo', '1989-12-22', 'Fairyland', '425347586972825', 3);
INSERT INTO usager (civilite, nom, prenom, sexe, adresse, code_postal, ville, date_nais, lieu_nais, num_secu, id_medecin) VALUES ('M.', 'Nanami', 'Kento', 'H', '89 Tokyo Street', '75003', 'Tokyo', '1988-02-16', 'Fairyland', '637289453619805', 1);
INSERT INTO usager (civilite, nom, prenom, sexe, adresse, code_postal, ville, date_nais, lieu_nais, num_secu, id_medecin) VALUES ('M.', 'Mouse', 'Mickey', 'H', '123 Disney Lane', '75004', 'Magic City', '1928-11-18', 'Fairyland', '456789012345678', 4);
...
INSERT INTO usager (civilite, nom, prenom, sexe, adresse, code_postal, ville, date_nais, lieu_nais, num_secu, id_medecin) VALUES ('M.', 'Ali', 'Aladdin', 'H', '789 Disney Lane', '75015', 'Magic City', '1992-11-25', 'Fairyland', '987654321098765', 6);
...
INSERT INTO usager (civilite, nom, prenom, sexe, adresse, code_postal, ville, date_nais, lieu_nais, num_secu, id_medecin) VALUES ('M.', 'Midoriya', 'Izuku', 'H', '789 Hero Avenue', '75010', 'Musutafu', '2002-07-15', 'Musutafu', '456123789012345', 1);
...
INSERT INTO usager (civilite, nom, prenom, sexe, adresse, code_postal, ville, date_nais, lieu_nais, num_secu, id_medecin) VALUES ('M.', 'Bakugo', 'Katsuki', 'H', '123 Hero Avenue', '75012', 'Musutafu', '2002-04-20', 'Musutafu', '678345901234567', 3);
...
INSERT INTO usager (civilite, nom, prenom, sexe, adresse, code_postal, ville, date_nais, lieu_nais, num_secu, id_medecin) VALUES ('M.', 'Todoroki', 'Shoto', 'H', '456 Hero Avenue', '75014', 'Musutafu', '2002-01-11', 'Musutafu', '890567123456789', 5);
